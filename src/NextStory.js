...
class NextStory extends Component {
    ...
    next = () => {
        ...
        if (this.props.score >= 1 && this.props.heart >= 1) {
            this.setState({ costh: this.state.costh + this.state.costh * 3, costm: this.state.costm + this.state.costm * 6 })
    ...
    render() {
        ...
        return (
            ...
            + {this.state.costm}
                        ...
                        :
                        <button type="button" class="btn btn-success btn-lg" hidden    >
                        </button>
...
export default connect(mapStateToProps)(NextStory);